...
ic_input_filename = "/gpfs/projects/MirandaGroup/victoria/cola_projects/test_5/transfers/4/transferinfo.dat"

output_folder = "/gpfs/projects/MirandaGroup/victoria/cola_projects/test_5/output/no_pairfix/4"
simulation_name = "run_4"
...
cosmology_OmegaCDM = 0.3004720768043272
cosmology_Omegab = 0.05986651083720328
cosmology_OmegaMNu = 0.0014776456288093454
...
cosmology_h = 0.6457506035249244
cosmology_As = 2.4650656894502455e-09
cosmology_ns = 0.9434101088980904
cosmology_kpivot_mpc = 0.05
cosmology_OmegaK = 0.0
if cosmology_model == "w0waCDM" then 
  cosmology_w0 = -0.7618803713104383
  cosmology_wa = -0.08858150928505015
end
