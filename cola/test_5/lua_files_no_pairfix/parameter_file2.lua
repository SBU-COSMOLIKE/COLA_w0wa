...
ic_input_filename = "/gpfs/projects/MirandaGroup/victoria/cola_projects/test_5/transfers/2/transferinfo.dat"

output_folder = "/gpfs/projects/MirandaGroup/victoria/cola_projects/test_5/output/no_pairfix/2"
simulation_name = "run_2"
...
cosmology_OmegaCDM = 0.3276027765416629
cosmology_Omegab = 0.05372546630045979
cosmology_OmegaMNu = 0.0012080166832826816
...
cosmology_h = 0.714189566524508
cosmology_As = 1.9289851681846117e-09
cosmology_ns = 0.9842868406953973
cosmology_kpivot_mpc = 0.05
cosmology_OmegaK = 0.0
if cosmology_model == "w0waCDM" then 
  cosmology_w0 = -0.9597854504906549
  cosmology_wa = -0.2637673606702513
end
