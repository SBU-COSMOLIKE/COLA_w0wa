...
ic_input_filename = "/gpfs/projects/MirandaGroup/victoria/cola_projects/test_5/transfers/1/transferinfo.dat"

output_folder = "/gpfs/projects/MirandaGroup/victoria/cola_projects/test_5/output/no_pairfix/1"
...
if cosmology_model == "w0waCDM" then 
  cosmology_w0 = -1.1606357178110513
  cosmology_wa = -0.5406916806591751
end
